...
urlcontent ="https://m.qidian.com/book/{}/{}".format("1015189924","461818539")
#url为获取下一章节id的url,通过requesturl获得
url = "https://m.qidian.com/book/1015189924/0&bookId={}&chapterId={}".format("1003782761","321319656")
#保存爬取的小说内容
f = open('test.txt', 'w')
...
for i in range(5):
    ...
    urlcontent = "https://m.qidian.com/book/{}/{}".format("1015189924", nextId)
